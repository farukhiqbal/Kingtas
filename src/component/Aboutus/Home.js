...
<section className="hero hero-home">
      <div className="swiper-container hero-slider swiper-container-horizontal">
        <div className="swiper-wrapper">
          {/* Slide 1 */}
          <div className="swiper-slide">
            <div style={{ background: 'url(slide/slide-1.jpg)' }} className="hero-content has-overlay-dark">
              <div className="container">
                <div className="row">
                  <div className="col-lg-8">
                    <h1>Welcome to <span>KINAHS</span></h1>
                    <p className="hero-text pr-5">
                      To be successful you don't need a beautiful face and a heroic body. What you need is a skillful mind and the ability to perform.
                    </p>
                    <div className="CTAs">
                      <a href="student_login.aspx" className="btn btn-primary">Apply now</a>
          ...
          {/* Slide 2 */}
          <div className="swiper-slide">
            <div style={{ background: 'url(slide/slide-2.jpg)' }} className="hero-content has-overlay-dark">
              <div className="container">
                <div className="row">
                  <div className="col-lg-8">
                    <h1>Welcome to <span>KINAHS</span></h1>
          ...
          <div className="swiper-slide swiper-slide-active">
            <div style={{ background: 'url(slide/slide-3.jpg)' }} className="hero-content has-overlay-dark">
              <div className="container">
                <div className="row">
                  <div className="col-lg-8">
                    <h1>Welcome to <span>KINAHS</span></h1>
