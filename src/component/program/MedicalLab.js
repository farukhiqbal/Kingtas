...
import medical_lab from '../../assets/images/medical-lab.webp'
      ...
      <div className="  grid    xl:w-[78%]  mx-auto      grid-cols-1    my-[2rem]    lg:grid-cols-2    xl:grid-cols-3    ">
        <div className="col-span-2       px-[2.5rem]">
          <h3 className="font-bold sm:text-center md:text-left lg:left  ">
            ...
            >
              Scope of &nbsp; Medical Laboratory Technology
            </Link>
          </h3>

          <p className="mt-2 pt-2    text-xl  justify-normal   leading-[3rem]      ">
            This course provides students with foundational knowledge and
            practical skills required to conduct medical laboratory tests
            essential for diagnosing and treating diseases. It covers topics in
            hematology, microbiology, biochemistry, and pathology, preparing
            students for a career in clinical laboratories.
          </p>
        </div>
        ...
        <div className="    right   ">
          <img
            src={medical_lab}
            alt="medical lab technology image "
