...
<div class="text-sm font-bold px-2 flex justify-between mx-auto sm:w-full sm:mx-0 md:w-3/4 lg:w-3/4 md:mx-auto my-5">
  <h2 class="text-left text-[1.2rem]  md:text-xl lg:text-xl">
    <strong>Documents Required:-(All docs should be attested by a grade 17 officer)</strong>
  </h2>
  <p class="bg-red-500 text-white px-4 py-2 rounded cursor-pointer">Apply Now</p>
</div>
...
<div className="sm:w-full xm:overflow-x-scroll md:w-3/4 lg:w-3/4 md:mx-auto mb[2rem]">
    ...
    <div class="text-sm font-bold px-2 mx-auto sm:w-full sm:mx-0 md:w-3/4 lg:w-3/4 md:mx-auto mt-5">
      ...
      <div class="text-sm font-bold px-2 mx-auto flex justify-between sm:w-full sm:mx-0 md:w-3/4 lg:w-3/4 md:mx-auto py-3">
        <h2 class="text-left text-[1.2rem]  md:text-xl lg:text-xl">
          <strong>
...
<div class="text-sm font-bold px-2 flex justify-between mx-auto sm:w-full sm:mx-0 md:w-3/4 lg:w-3/4 md:mx-auto my-5">
  ...
  <button class="bg-red-500 text-white px-4 py-2 rounded cursor-pointer">Apply Now</button>
